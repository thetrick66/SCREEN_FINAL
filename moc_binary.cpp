...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_binary_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 29, 0)
    ...
    "binary\0on_pushButton_clicked\0"
};
...
void binary::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        binary *_t = static_cast<binary *>(_o);
        switch (_id) {
...
const QMetaObject binary::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_binary.data,
      qt_meta_data_binary,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_binary.stringdata))
        return static_cast<void*>(const_cast< binary*>(this));
